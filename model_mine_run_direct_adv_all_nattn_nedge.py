...
if __name__ == '__main__':
    ...
    model=Main_Model(image_size=crop_size[0],num_models=4,with_edge=False,with_attn=False,encoder_name_ls=encoder_name_ls,attn_features=args.attn_features).cuda()
    ...
    for epoch in tqdm(range(args.epochs)):
        ...
        for img,label in tqdm(dataloader_train):
            ...
            loss_sum=loss_n_class+loss_class_consistency+loss_dice_normal+reg_loss*3
