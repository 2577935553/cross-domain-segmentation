...
if __name__ == '__main__':
    ...
    model=Main_Model(image_size=crop_size[0],num_models=4,with_edge=True,with_attn=True,encoder_name_ls=encoder_name_ls,attn_features=args.attn_features).cuda()
    ...
    for epoch in tqdm(range(args.epochs)):
        ...
        for img,label in tqdm(dataloader_train):
            ...
            reg_loss_ls.append((reg_loss*2).item())
